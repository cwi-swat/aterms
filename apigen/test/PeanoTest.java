        ...
        public ATerm apply(ATerm atermSubject) {
          ...
          if(subject.isPlus()) {
            ...
            if(arg2.isZero()) {
              ...
              Nat y = arg2.getPred();
              return factory.makeNat_Suc(factory.makeNat_Plus(arg1,y));
            }
          } else if(subject.isFib()) {
            Nat t = subject.getArg1();
            if(t.isZero()) {
              return factory.makeNat_Suc(t);
            } else if (t.isSuc() && t.getPred().isZero()) {
              return t.getPred();
            } else {
              Nat pred1 = t.getPred();
              Nat pred2 = pred1.getPred();
              return factory.makeNat_Plus(
                factory.makeNat_Fib(pred2),
                factory.makeNat_Fib(pred1));
            }
          }
          return null;
        }
