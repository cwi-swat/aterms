...
static ATerm lf_AUX_Literals_Sdf_Syntax1_4 ( ATerm arg1 , ATerm arg2 , ATerm arg3 , ATerm arg4 ) ;
...
static ATerm lf_AUX_Literals_Sdf_Syntax1_6 ( ATerm arg1 ) ;
...
lf_AUX_Literals_Sdf_Syntax1_4sym = ATmakeSymbol ( "prod(id(\"Literals-Sdf-Syntax\"),w(\"\"),[sort(\"Literal\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\"),w(\"\"),ql(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),sort(\"Attributes\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Production\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"avoid\")],w(\"\"),l(\"}\")))" , 4 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Literals_Sdf_Syntax1_4sym ) ;
lf_AUX_Literals_Sdf_Syntax1_3sym = ATmakeSymbol ( "listtype(sort(\"Symbol\"),ql(\",\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Literals_Sdf_Syntax1_3sym ) ;
lf_AUX_Literals_Sdf_Syntax1_5sym = ATmakeSymbol ( "prod(id(\"Literals-Sdf-Syntax\"),w(\"\"),[sort(\"Literal\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Literals_Sdf_Syntax1_5sym ) ;
lf_AUX_Literals_Sdf_Syntax1_6sym = ATmakeSymbol ( "prod(id(\"Literals-Sdf-Syntax\"),w(\"\"),[sort(\"UQLiteral\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Literal\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "listtype(sort(\"Symbol\"),ql(\",\"))" ) , lf_AUX_Literals_Sdf_Syntax1_3 , lf_AUX_Literals_Sdf_Syntax1_3sym ) ;
register_prod ( ATparse ( "prod(id(\"Literals-Sdf-Syntax\"),w(\"\"),[sort(\"Literal\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\"),w(\"\"),ql(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),sort(\"Attributes\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Production\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"avoid\")],w(\"\"),l(\"}\")))" ) , lf_AUX_Literals_Sdf_Syntax1_4 , lf_AUX_Literals_Sdf_Syntax1_4sym ) ;
register_prod ( ATparse ( "prod(id(\"Literals-Sdf-Syntax\"),w(\"\"),[sort(\"Literal\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),no-attrs)" ) , lf_AUX_Literals_Sdf_Syntax1_5 , lf_AUX_Literals_Sdf_Syntax1_5sym ) ;
register_prod ( ATparse ( "prod(id(\"Literals-Sdf-Syntax\"),w(\"\"),[sort(\"UQLiteral\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Literal\"),w(\"\"),no-attrs)" ) , lf_AUX_Literals_Sdf_Syntax1_6 , lf_AUX_Literals_Sdf_Syntax1_6sym ) ;
}
void resolve_AUX_Literals_Sdf_Syntax1 ( ) {
}
void init_AUX_Literals_Sdf_Syntax1 ( ) {
}
ATerm lf_AUX_Literals_Sdf_Syntax1_6 ( ATerm arg0 ) {
CONS_ENTRY ( lf_AUX_Literals_Sdf_Syntax1_6sym , ATmakeAppl ( lf_AUX_Literals_Sdf_Syntax1_6sym , arg0 ) ) ;
CONS_EXIT ( make_nf1 ( lf_AUX_Literals_Sdf_Syntax1_6sym , arg0 ) ) ;
}
...
ATerm lf_AUX_Literals_Sdf_Syntax1_4 ( ATerm arg0 , ATerm arg1 , ATerm arg2 , ATerm arg3 ) {
CONS_ENTRY ( lf_AUX_Literals_Sdf_Syntax1_4sym , ATmakeAppl ( lf_AUX_Literals_Sdf_Syntax1_4sym , arg0 , arg1 , arg2 , arg3 ) ) ;
CONS_EXIT ( make_nf4 ( lf_AUX_Literals_Sdf_Syntax1_4sym , arg0 , arg1 , arg2 , arg3 ) ) ;
}
