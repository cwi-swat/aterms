...
static ATerm lf_AUX_Sdf2_to_ADT26_2_recursive ( ATerm arg1 , ATerm arg2 ) ;
static Symbol lf_AUX_Sdf2_to_ADT26_2sym ;
static ATerm lf_AUX_Sdf2_to_ADT26_2 ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Sdf2_to_ADT26_2_recursivesym = ATmakeSymbol ( "prod(id(\"Sdf2-to-ADT\"),w(\"\"),[ql(\"build-asfix-attr-list\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Attribute\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\",\"),w(\"\"),sort(\"ConsOption\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerms\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Sdf2_to_ADT26_2_recursivesym ) ;
lf_AUX_Sdf2_to_ADT26_2sym = ATmakeSymbol ( "prod(id(\"Sdf2-to-ADT\"),w(\"\"),[ql(\"build-asfix-attr-list\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Attribute\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\",\"),w(\"\"),sort(\"ConsOption\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerms\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Sdf2-to-ADT\"),w(\"\"),[ql(\"build-asfix-attr-list\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Attribute\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\",\"),w(\"\"),sort(\"ConsOption\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerms\"),w(\"\"),no-attrs)" ) , lf_AUX_Sdf2_to_ADT26_2 , lf_AUX_Sdf2_to_ADT26_2sym ) ;
register_prod ( ATparse ( "prod(id(\"Sdf2-to-ADT\"),w(\"\"),[ql(\"build-asfix-attr-list\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Attribute\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\",\"),w(\"\"),sort(\"ConsOption\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerms\"),w(\"\"),no-attrs)" ) , lf_AUX_Sdf2_to_ADT26_2_recursive , lf_AUX_Sdf2_to_ADT26_2_recursivesym ) ;
...
ATerm lf_AUX_Sdf2_to_ADT26_2 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 8 ] ;
FUNC_ENTRY ( lf_AUX_Sdf2_to_ADT26_2sym , ATmakeAppl ( lf_AUX_Sdf2_to_ADT26_2sym , arg0 , arg1 ) ) ;
...
( tmp [ 4 ] = arg_0 ( tmp [ 3 ] ) ) ;
( tmp [ 5 ] = lf_AUX_Sdf2_to_ADT26_2 ( lf_AUX_Sdf2_to_ADT26_1 ( make_list ( tmp [ 1 ] ) ) , arg1 ) ) ;
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Sdf2_to_ADT26_2sym , arg0 , arg1 ) ) ;
}
}
ATerm lf_AUX_Sdf2_to_ADT26_2_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 8 ] ;
FUNC_ENTRY ( lf_AUX_Sdf2_to_ADT26_2_recursivesym , ATmakeAppl ( lf_AUX_Sdf2_to_ADT26_2_recursivesym , arg0 , arg1 ) ) ;
{
ATerm atmp00 = arg0 ;
if ( is_single_element ( atmp00 ) ) {
( tmp [ 0 ] = list_head ( atmp00 ) ) ;
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Sdf2_to_ADT26_2_recursivesym , lf_AUX_Sdf2_to_ADT26_1 ( arg0 ) , arg1 ) ) ;
}
}
