...
( tmp [ 13 ] = ( * ef16 ) ( atmp010 ) ) ;
( tmp [ 14 ] = ( * ef17 ) ( atmp010 ) ) ;
FUNC_EXIT ( ( * ef4 ) ( lf3 ( make_list ( make_nf1 ( ef6sym , ( * ef7 ) ( lf3 ( cons ( make_list ( make_nf1 ( ef8sym , tmp [ 13 ] ) ) , cons ( make_list ( make_nf1 ( ef8sym , tmp [ 12 ] ) ) , make_list ( make_nf2 ( ef9sym , ( * ef10 ) ( lf4 ( ( ATerm ) ATmakeList ( 3 , char_table [ 108 ] , char_table [ 101 ] , char_table [ 120 ] ) ) ) , lf3 ( cons ( make_list ( make_nf1 ( ef11sym , make_nf2 ( ef9sym , ( * ef10 ) ( lf4 ( ( ATerm ) ATmakeList ( 3 , char_table [ 108 ] , char_table [ 101 ] , char_table [ 120 ] ) ) ) , lf3 ( make_list ( make_nf1 ( ef8sym , ( * ef10 ) ( lf4 ( ( ATerm ) ATmakeList ( 3 , char_table [ 115 ] , char_table [ 116 ] , char_table [ 114 ] ) ) ) ) ) ) ) ) ) , make_list ( make_nf2 ( ef9sym , ( * ef10 ) ( lf4 ( ( ATerm ) ATmakeList ( 4 , char_table [ 115 ] , char_table [ 111 ] , char_table [ 114 ] , char_table [ 116 ] ) ) ) , lf3 ( make_list ( make_nf1 ( ef8sym , make_nf1 ( ef12sym , tmp [ 14 ] ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ;
}
}
}
}
