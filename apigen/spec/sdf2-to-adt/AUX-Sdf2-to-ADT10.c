...
static ATerm lf_AUX_Sdf2_to_ADT10_1 ( ATerm arg1 ) ;
...
lf_AUX_Sdf2_to_ADT10_1sym = ATmakeSymbol ( "prod(id(\"Sdf2-to-ADT\"),w(\"\"),[ql(\"lexical-to-adt\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Production\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerms\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Sdf2-to-ADT\"),w(\"\"),[ql(\"lexical-to-adt\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Production\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerms\"),w(\"\"),no-attrs)" ) , lf_AUX_Sdf2_to_ADT10_1 , lf_AUX_Sdf2_to_ADT10_1sym ) ;
...
ATerm lf_AUX_Sdf2_to_ADT10_1 ( ATerm arg0 ) {
{
ATerm tmp [ 15 ] ;
FUNC_ENTRY ( lf_AUX_Sdf2_to_ADT10_1sym , ATmakeAppl ( lf_AUX_Sdf2_to_ADT10_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Sdf2_to_ADT10_1sym , arg0 ) ) ;
}
}
