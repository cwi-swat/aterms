...
static ATerm lf_AUX_Build_General_AsFix2ME_ADT3_1 ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
...
lf_AUX_Build_General_AsFix2ME_ADT3_1sym = ATmakeSymbol ( "prod(id(\"Build-General-AsFix2ME-ADT\"),w(\"\"),[ql(\"build-asfix-attrs\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ModuleName\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Attributes\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"ConsOption\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 3 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Build-General-AsFix2ME-ADT\"),w(\"\"),[ql(\"build-asfix-attrs\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ModuleName\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Attributes\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"ConsOption\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)" ) , lf_AUX_Build_General_AsFix2ME_ADT3_1 , lf_AUX_Build_General_AsFix2ME_ADT3_1sym ) ;
...
ATerm lf_AUX_Build_General_AsFix2ME_ADT3_1 ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
{
ATerm tmp [ 4 ] ;
FUNC_ENTRY ( lf_AUX_Build_General_AsFix2ME_ADT3_1sym , ATmakeAppl ( lf_AUX_Build_General_AsFix2ME_ADT3_1sym , arg0 , arg1 , arg2 ) ) ;
...
FUNC_EXIT ( make_nf3 ( lf_AUX_Build_General_AsFix2ME_ADT3_1sym , arg0 , arg1 , arg2 ) ) ;
}
}
