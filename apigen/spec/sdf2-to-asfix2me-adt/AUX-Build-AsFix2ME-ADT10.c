...
static Symbol lf_AUX_Build_AsFix2ME_ADT10_1sym ;
static ATerm lf_AUX_Build_AsFix2ME_ADT10_1 ( ATerm arg1 , ATerm arg2 ) ;
...
static funcptr ef8 ;
void register_AUX_Build_AsFix2ME_ADT10 ( ) {
lf_AUX_Build_AsFix2ME_ADT10_1sym = ATmakeSymbol ( "prod(id(\"Build-AsFix2ME-ADT\"),w(\"\"),[ql(\"build-asfix-iter-star\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Build_AsFix2ME_ADT10_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
lf3sym = ATmakeSymbol ( "listtype(sort(\"ATerm\"),ql(\",\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf3sym ) ;
register_prod ( ATparse ( "prod(id(\"Build-AsFix2ME-ADT\"),w(\"\"),[ql(\"build-asfix-iter-star\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)" ) , lf_AUX_Build_AsFix2ME_ADT10_1 , lf_AUX_Build_AsFix2ME_ADT10_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
register_prod ( ATparse ( "listtype(sort(\"ATerm\"),ql(\",\"))" ) , lf3 , lf3sym ) ;
}
void resolve_AUX_Build_AsFix2ME_ADT10 ( ) {
...
void init_AUX_Build_AsFix2ME_ADT10 ( ) {
}
ATerm lf_AUX_Build_AsFix2ME_ADT10_1 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 2 ] ;
FUNC_ENTRY ( lf_AUX_Build_AsFix2ME_ADT10_1sym , ATmakeAppl ( lf_AUX_Build_AsFix2ME_ADT10_1sym , arg0 , arg1 ) ) ;
...
FUNC_EXIT ( make_nf2 ( ef3sym , ( * ef1 ) ( lf2 ( ( ATerm ) ATmakeList ( 3 , char_table [ 108 ] , char_table [ 101 ] , char_table [ 120 ] ) ) ) , lf3 ( make_list ( make_nf2 ( ef3sym , ( * ef1 ) ( lf2 ( ( ATerm ) ATmakeList ( 9 , char_table [ 105 ] , char_table [ 116 ] , char_table [ 101 ] , char_table [ 114 ] , char_table [ 45 ] , char_table [ 115 ] , char_table [ 116 ] , char_table [ 97 ] , char_table [ 114 ] ) ) ) , lf3 ( make_list ( ( * ef4 ) ( atmp10 ) ) ) ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf2 ( ef3sym , arg0 , lf3 ( make_list ( make_nf2 ( ef3sym , ( * ef1 ) ( lf2 ( ( ATerm ) ATmakeList ( 9 , char_table [ 105 ] , char_table [ 116 ] , char_table [ 101 ] , char_table [ 114 ] , char_table [ 45 ] , char_table [ 115 ] , char_table [ 116 ] , char_table [ 97 ] , char_table [ 114 ] ) ) ) , lf3 ( make_list ( make_nf2 ( ef3sym , ( * ef1 ) ( lf2 ( ( ATerm ) ATmakeList ( 4 , char_table [ 115 ] , char_table [ 111 ] , char_table [ 114 ] , char_table [ 116 ] ) ) ) , lf3 ( make_list ( make_nf1 ( ef6sym , tmp [ 0 ] ) ) ) ) ) ) ) ) ) ) ) ;
}
}
FUNC_EXIT ( make_nf2 ( lf_AUX_Build_AsFix2ME_ADT10_1sym , arg0 , arg1 ) ) ;
}
}
