...
static Symbol lf_AUX_Build_General_AsFix2ME_ADT6_1sym ;
static ATerm lf_AUX_Build_General_AsFix2ME_ADT6_1 ( ATerm arg1 , ATerm arg2 ) ;
...
static funcptr ef10 ;
void register_AUX_Build_General_AsFix2ME_ADT6 ( ) {
lf_AUX_Build_General_AsFix2ME_ADT6_1sym = ATmakeSymbol ( "prod(id(\"Build-General-AsFix2ME-ADT\"),w(\"\"),[ql(\"build-asfix-attr\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Attribute\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"ConsOption\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerms\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Build_General_AsFix2ME_ADT6_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"ATerm\"),ql(\",\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
lf3sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf3sym ) ;
register_prod ( ATparse ( "prod(id(\"Build-General-AsFix2ME-ADT\"),w(\"\"),[ql(\"build-asfix-attr\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Attribute\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"ConsOption\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerms\"),w(\"\"),no-attrs)" ) , lf_AUX_Build_General_AsFix2ME_ADT6_1 , lf_AUX_Build_General_AsFix2ME_ADT6_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"ATerm\"),ql(\",\"))" ) , lf2 , lf2sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf3 , lf3sym ) ;
}
void resolve_AUX_Build_General_AsFix2ME_ADT6 ( ) {
...
void init_AUX_Build_General_AsFix2ME_ADT6 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
ATprotect ( & constant2 ) ;
ATprotect ( & constant3 ) ;
...
ATerm lf_AUX_Build_General_AsFix2ME_ADT6_1 ( ATerm arg0 , ATerm arg1 ) {
FUNC_ENTRY ( lf_AUX_Build_General_AsFix2ME_ADT6_1sym , ATmakeAppl ( lf_AUX_Build_General_AsFix2ME_ADT6_1sym , arg0 , arg1 ) ) ;
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Build_General_AsFix2ME_ADT6_1sym , arg0 , arg1 ) ) ;
}
