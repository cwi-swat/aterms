...
public class TypeConverter implements TypeConversions {
	...
	private Map<String, String> reservedTypes;
	...
	public TypeConverter(TypeConversions conv) {
		reservedTypes = new HashMap<String, String>();
	...
	public String getIntegerType() {
		return reservedTypes.get(INT_TYPE);
	}
	...
	public String getRealType() {
		return reservedTypes.get(REAL_TYPE);
	}
	...
	public String getStringType() {
		return reservedTypes.get(STR_TYPE);
	}
	...
	public String getTermType() {
		return reservedTypes.get(TERM_TYPE);
	}
	...
	public String getListType() {
		return reservedTypes.get(LIST_TYPE);
	}

	public String getCharsType() {
		return reservedTypes.get(CHARS_TYPE);
	}

	public String getCharType() {
		return reservedTypes.get(CHAR_TYPE);
	}
