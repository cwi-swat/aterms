...
public class AbstractListGenerator extends JavaGenerator {
	...
	public AbstractListGenerator(ADT adt, JavaGenerationParameters params,
			Module module) {
		super(params);
		this.adt = adt;
	...
	public String qualifiedClassName(JavaGenerationParameters params) {
		return AbstractListGenerator.qualifiedClassName(params, module
				.getModulename().getName());
	}
	...
	private void genConstructor() {
		println("  public "
				...
				+ "("
				+ factoryClassName
				+ " abstractTypeFactory, aterm.ATermList annos, aterm.ATerm first, aterm.ATermList next) {");
