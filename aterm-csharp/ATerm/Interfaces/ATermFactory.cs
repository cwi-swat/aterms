...
namespace aterm
{
	// public byte START_OF_SHARED_TEXT_FILE = (byte)'!';
	...
	public interface ATermFactory
	{
		...
		*
		 ...
		 */
		ATerm make(string pattern, ArrayList args);
		 ...
		 * @return the constructed term.
		 */
		ATerm make(ATerm pattern, ArrayList args);
		 ...
		 */
		AFun makeAFun(string name, int arity, bool isQuoted);
		 ...
		 */
		ATerm readFromTextFile(System.IO.Stream stream); // throws IOException;
		 ...
		 * @return the parsed ATerm.
		 */
		ATerm readFromSharedTextFile(System.IO.Stream stream); // throws IOException;
		 ...
		 * @return the parsed ATerm.
		 */
		ATerm readFromBinaryFile(System.IO.Stream stream); // throws IOException;
		 ...
		 * @return the parsed ATerm.
		 */
		ATerm readFromFile(System.IO.Stream stream); // throws IOException;
